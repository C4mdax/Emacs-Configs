...
(def-doom-theme doom-gruvbox
  ...
  ;; name        gui       256       16
  ((bg
    (cond ((equal doom-gruvbox-dark-variant "hard") '("#1f1f1f" "#1e1e1e" nil))   ; bg0_h
          ((equal doom-gruvbox-dark-variant "soft") '("#32302f" "#323232" nil))   ; bg0_s
          (t                                        '("#1f1f1f" "#1f1f1f" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-gruvbox-dark-variant "hard") '("#0d1011" "black" nil))     ; (self-defined)
          ((equal doom-gruvbox-dark-variant "soft") '("#1f1f1f" "#1f1f1f" nil))   ; bg0
          (t                                        '("#1f1f1f" "#1e1e1e" nil)))) ; bg_h
   (bg-alt2    '("#504945" "#504945" "brown"      )) ; bg2 (for region, selection etc.)

   (base0      '("#0d1011" "black"   "black"      )) ; (self-defined)
   (base1      '("#1f1f1f" "#1d1d1d" "brightblack")) ; bg0_h
   (base2      '("#1f1f1f" "#1f1f1f" "brightblack")) ; bg0
   ...
   (red         '("#de4141" "#e74c3c" "red"))           ; bright-red
   ...
   (dark-green  '("#719e1a" "#719e1a" "green"))         ; green
   (blue        '("#5c9c93" "#5c9c93" "brightblue"))    ; bright-blue
   (dark-blue   '("#11989e" "#11989e" "blue"))          ; blue
   (cyan        '("#8ec07c" "#8ec07c" "brightcyan"))    ; bright-aqua
   (my-black    '("#1a1a19" "#1a1a19" "black"))
